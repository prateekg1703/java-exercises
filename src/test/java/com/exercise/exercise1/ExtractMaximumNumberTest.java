...
class ExtractMaximumNumberTest {
  ...
  /**
   * This test case comprises of 5 test cases together using parameterized test annotation provided
   * by Junit 5 Jupiter params i.e. 1) String has no numeric value, 2) String has maximum number at
   * start, 3) String has maximum number at end, 4) String has maximum number in between, and 5)
   * String has a maximum number greater than an Integer can support.
   *
